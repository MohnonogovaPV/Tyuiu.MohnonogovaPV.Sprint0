using Tyuiu.MohnonogovaPV.Sprint0.Task7.V0.Lib;
namespace Tyuiu.MohnonogovaPV.Sprint0.Task7.V0
{
    internal class Program
    {
        static void Main(string[] args)
        {
            Console.Title = ("Спринт #0 | Выполнила: Мохноногова П.В. | АСОиУб24-1");
            Console.WriteLine("****************************************************************************");
            ...
            {
                int[] resulArray = DataService.AdditionArray(arrayNums1, arrayNums2);
